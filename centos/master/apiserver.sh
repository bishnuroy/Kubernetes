...
KUBE_API_CLIENT_CA_FILE="--client-ca-file=/opt/kubernetes/ssl/apiserver.csr"
...
KUBE_API_TLS_CERT_FILE="--tls-cert-file=/opt/kubernetes/ssl/apiserver.pem"
# --tls-private-key-file="": File containing x509 private key matching --tls-cert-file.
KUBE_API_TLS_PRIVATE_KEY_FILE="--tls-private-key-file=/opt/kubernetes/ssl/apiserver-key.pem"
EOF
